package org.leekeggs.quartzextendschedulercenter.service.support;
 ...
 */
@Component
public class ReplaceCookieProcessorTomcatContextCustomizer implements TomcatContextCustomizer {

    private final MyCookieProcessor cookieProcessor = new MyCookieProcessor();
    ...
    // 复制org.apache.tomcat.util.http.Rfc6265CookieProcessor类的代码，仅修改了COOKIE_DATE_FORMAT，适配本地时区
    public static class MyCookieProcessor extends CookieProcessorBase {
        ...
        public void parseCookieHeader(MimeHeaders headers,
            ...
            while (pos >= 0) {
                ...
                if (cookieValue != null && !cookieValue.isNull()) {
                    ...
                    org.apache.tomcat.util.http.parser.Cookie.parseCookie(bc.getBytes(), bc.getOffset(), bc.getLength(),
                            serverCookies);
                }
