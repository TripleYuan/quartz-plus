...
import org.leekeggs.quartzextendschedulercenter.service.support.ApiPathRegister.ApiPath;
...
public class ApiPathCollector implements BeanPostProcessor {
    ...
    private String targetPackage = "org.leekeggs.quartzextendschedulercenter.controller";
    ...
    private void registerApiPath(Class<?> clazz) {
        List<ApiPath> apiPaths = new ArrayList<>(10);
    ...
    private void addApiPath(String[] mappingValue, List<ApiPath> apiPaths, String pathPrefix, String description) {
        for (String s : mappingValue) {
            apiPaths.add(new ApiPath(pathPrefix + s, description));
        }
    }
}
