...
import static org.leekeggs.quartzextendschedulercenter.constant.QuartzApiConstants.JOB_TRIGGER_INFO_LIST;
...
@QuartzTrigger(triggerDescription = "JobTriggerInfoCollectingJob's trigger", cronExpress = "0 0/5 * * * ?")
